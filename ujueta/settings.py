"""
Django settings for ujueta project.
...
SECRET_KEY = 'az7!cqumj=5eq(c#phd6=mzpdxjlru(k)f1!&&jl_4(@35b%f2'
...
WSGI_APPLICATION = 'ujueta.wsgi.application'
...
REST_FRAMEWORK = {
	'DEFAULT_PAGINATION_CLASS': 'ujueta.pagination.CustomPagination',
	'PAGE_SIZE': 10
}
